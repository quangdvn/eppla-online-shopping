...
class ProductsController extends VoyagerBaseController
{
    ...
    //* Some protected Utils function
    protected function modifyProductCategory(Request $request, $id)
    {
        if ($request->category) {
    ...
    public function edit(Request $request, $id)
    {
        ...
        $curProduct = Product::findOrFail($id);

        $categoriesForProduct = $curProduct->categories()->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        //* Clear all the old categories of this product
        CategoryProduct::where('product_id', $id)->delete();

        //* Re-insert the categories for this product
        $this->modifyProductCategory($request, $id);
    ...
    public function store(Request $request)
    {
        ...
        //* Insert the categories for this new created product
        $this->modifyProductCategory($request, $data->id);
