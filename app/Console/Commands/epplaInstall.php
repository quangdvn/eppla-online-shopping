...
class epplaInstall extends Command
{
     ...
     * @var string
     */
    protected $signature = 'eppla:install {--force : Do not ask for user confirmation}';
     ...
     * @var string
     */
    protected $description = 'Install dummy data for Eppla Clone';
    ...
    protected function proceed()
    {
        ...
        //* Make a link from Storage to Public
        $this->callSilent('storage:link');

        //* Copy all img from public to Storage to fit the path in Url
        $copySuccess = File::copyDirectory(public_path('img/products'), public_path('storage/products/November2019'));
        if ($copySuccess) {
